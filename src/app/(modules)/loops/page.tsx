...
export const metadata: Metadata = {
  ...
  description:
    'Анимиран преглед на for/while цикли, натрупване на сума и контрол на итерациите с куиз.'
};
      ...
      <section className="grid gap-6 md:grid-cols-3">
        <Card className="md:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Фокус върху контрол на итерациите и броячи.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Цикъл върху масив от n елемента.</CardDescription>
          </CardHeader>
