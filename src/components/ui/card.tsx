...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_10px_40px_-25px_rgba(62,111,255,0.45)] transition hover:shadow-[0_18px_55px_-25px_rgba(62,111,255,0.55)]',
        className
      )}
      {...props}
    />
